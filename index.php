...
if(!is_dir('fotoBoothImages')){
	shell_exec('sudo mkdir fotoBoothImages');
	//sudo mkdir('fotoBoothImages');
}
if(!is_dir('fotoBoothImagesThumbs')){
	shell_exec('sudo mkdir fotoBoothImagesThumbs');
	//mkdir('fotoBoothImagesThumbs');
}
	...
	<div id="wrapper">
		...
		<div class="stages" id="start">
			...
			<div class="inner">
				...
				<a href="#" class="btn takePic"><h3><span style="font-size:xx-large" data-l10n="takePic"></span><h3></a>
			</div>
		</div>
		...
		<div class="stages" id="result">
			...
			<!-- <a href="#" class="btn newpic"><h3><span data-l10n="takePic"></span></h3></a> -->
			</div>
		</div>
...
<!--					<a href="#" class="close_gal"><i class="fa fa-times"></i></a> -->
	...
	<script type="text/javascript">
		...
		console.log( "ready!" );
		//start pollin to get status of pedal
		//if pedal is active, tape a pic otherwise wait
		
		photoBooth.resetPedalStatus();
		});
	</script>
</body>
</html>
